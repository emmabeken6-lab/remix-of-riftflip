  ...
  public: {
    Tables: {
      ...
      game_bets: {
        ...
        Relationships: [
          {
            foreignKeyName: "game_bets_game_id_fkey"
            columns: ["game_id"]
            isOneToOne: false
      ...
      word_crumbles: {
        ...
        Relationships: [
          {
            foreignKeyName: "word_crumbles_chat_message_id_fkey"
          ...
          {
            foreignKeyName: "word_crumbles_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "word_crumbles_winner_id_fkey"
            columns: ["winner_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
    ...
    Enums: {
      app_role: "admin" | "user"
      game_status: "open" | "resolved" | "cancelled"
      giveaway_status: "active" | "ended" | "cancelled"
      tx_reason:
        | "admin_grant"
        | "admin_deduct"
        | "bet_placed"
